...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background: #f5f5f5;">
                    ...
                    <tr>
                        <td style="padding: 48px 40px;">
                            ...
                            <p style="color: #4a5568; font-size: 16px; line-height: 1.6; margin: 0 0 24px 0;">
                                Thank you for joining OpenMedicine. You're among the first to experience the future of AI-powered healthcare guidance.
                            </p>
                            ...
                            <div style="background: #f7fafc; border-left: 4px solid #4CB3D4; padding: 20px; margin: 32px 0;">
                                ...
                                <ul style="color: #4a5568; font-size: 15px; line-height: 1.8; margin: 0; padding-left: 20px;">
                                    <li><strong>Priority Access:</strong> First to try OpenMedicine when we launch</li>
                            ...
                            <div style="text-align: center; margin: 40px 0;">
                                <a href="https://openmedicine.io" style="display: inline-block; background: linear-gradient(135deg, #8A7CF4, #4CB3D4); color: white; padding: 16px 48px; border-radius: 100px; text-decoration: none; font-weight: 600;">
                                    Visit OpenMedicine
                                </a>
                            </div>
    ...
    const res = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'OpenMedicine <welcome@openmedicine.io>',
        to: record.email,
